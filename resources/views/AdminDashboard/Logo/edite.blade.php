    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form  action="{{ route('LogoUpdate',$edite->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row gutters">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                            <div class="form-group">
                                ...
                                <span style="color:red">Max Size: Width:120px, Height:60px</span>
                                @error('logo')
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control @error('footer_logo') is-invalid @enderror" name="footer_logo" id="imgInp" placeholder="Enter  footer_logo">
                                <span style="color:red">Max Size: Width:120px, Height:60px</span>
                                @error('footer_logo')
                                <span class="invalid-feedback" role="alert">
                                               	 <strong style="color:red">{{$message}}</strong>
                        ...
                        @if($edite->footer_logo)
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                                <div class="form-group">
                                    <label for="inputName">Old Image</label>
                                    <img src="{{(@$edite->footer_logo)?url('upload/Client/FooterLogo/'.@$edite->footer_logo):''}}" alt="">
