    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h2 style="font-family: monospace;font-weight: normal;">Color Edit:</h2>

                <form action="{{ route('ColorUpdate') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row gutters">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('color_name') is-invalid @enderror" value="{{@$edite->color_name}}" name="color_name" id="imgInp" placeholder="Enter color_name">
                                @error('color_name')
