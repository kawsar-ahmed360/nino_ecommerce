                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="@if(@$edite){{ route('ContactInfoUpdate') }} @else @endif" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row gutters">
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                <label for="inputName">Cell Phone Number</label>
                                                <input type="text" class="form-control @error('cellphone') is-invalid @enderror" @if(@$edite->cellphone) value="{{@$edite->cellphone}}" @else @endif name="cellphone" id="imgInp" placeholder="Enter cellphone">
                                                @error('cellphone')
                                                <span class="invalid-feedback" role="alert">
                                               	 <strong style="color:red">{{$message}}</strong>
                                               </span>
