...
<table style="width:100%;background:#AD0A40;padding: 10px;border-radius: 20px 10px 10px 0px" cellspacing="0" cellpadding="0" >
    @php
...
@foreach(@$Order as $key=>$pri)
    ...
    <div class="fullname" style="min-height:100% !important;">
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="0" style="margin-top: 20px;padding:7px">
            <thead>
            <tr align="center">
