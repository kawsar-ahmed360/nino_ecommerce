...
@section('admin-content')
    ...
    <div class="table-container">
        <div class="t-header">All Approve Product List  <a href="{{route('ProductCreate')}}"><span style="float: right;cursor:pointer" class="btn btn-success btn-sm">Add Product</span></a></div>
