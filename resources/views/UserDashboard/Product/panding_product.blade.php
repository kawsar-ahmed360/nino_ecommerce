...
@section('user-content')
    ...
    <div class="table-container">
        <div class="t-header">All Panding Product List  <a href="{{route('UserProductCreate')}}"><span style="float: right;cursor:pointer" class="btn btn-success btn-sm">Add Product</span></a></div>
